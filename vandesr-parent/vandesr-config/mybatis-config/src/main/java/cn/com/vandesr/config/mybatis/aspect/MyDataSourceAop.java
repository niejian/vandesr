package cn.com.vandesr.config.mybatis.aspect;

import cn.com.vandesr.config.mybatis.datasource.DBContextHolder;
...
public class MyDataSourceAop {
    @Pointcut("!@annotation(cn.com.vandesr.config.mybatis.annotation.Master) " +
