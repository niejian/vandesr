drop table vandesr_user if exists vandesr_user;
...
drop table vandesr_role if exists vandesr_role;
...
drop table vandesr_user_role if exists vandesr_user_role;
...
drop table vandesr_menu if exists vandesr_menu;
...
drop table vandesr_role_menu if exists vandesr_role_menu;
create table vandesr_menu (
  id int primary key auto_increment,
  role_id int not null ,
